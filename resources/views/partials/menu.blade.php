        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(Qs::userIsTeamSA())
                    ...
                    {{--Manage Sections--}}
                    <li class="nav-item">
                        <a href="{{ route('sections.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['sections.index','sections.edit',]) ? 'active' : '' }}"><i class="icon-fence"></i> <span>Streams</span></a>
                    </li>
                ...
                @if(Qs::userIsTeamSAT())
                    {{--Manage Users--}}
                    <li class="nav-item">
                        <a href="{{ route('notifications.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['notifications.index', 'notifications.show', 'notifications.edit']) ? 'active' : '' }}"><i class="icon-users4"></i> <span>Notifications</span></a>
                    </li>
                @endif
